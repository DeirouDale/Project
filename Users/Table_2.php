...
<body style="background: var(--grey); overflow-x: hidden;">
    ...
    <section id="content">
        ...
        <tbody>
            <tr>
                <td contenteditable="true">Madrasah Education Program (MEP) - Muslim</td>
            ...
            <tr>
                <td contenteditable="true">Madrasah Education Program (MEP) - Non-Muslim</td>
            ...
            <tr>
                <td contenteditable="true">Special Science Elementary School (SSES)</td>
...
<?php endforeach; ?>
                ...
                <div class="table-container" id="learners-table" style="display: none;">
                    ...
                    <thead>
        <tr>
            <th rowspan="3" style="width: 15%;">Classification/Types of Disabilities</th>
            <th colspan="13">Homebound</th>
            <th colspan="13">Hospital Bound</th>
            
        </tr>
        <tr>
            <th colspan="5">Age Profile</th>
            <th colspan="3">Grade Placement</th>
            <th colspan="5">Length of Time in the Program</th>
            <th colspan="5">Age Profile</th>
            <th colspan="3">Grade Placement</th>
            <th colspan="5">Length of Time in the Program</th>
        ...
        <tr>
            <th>5-10 years old</th>
            <th>11-15 years old</th>
            <th>16-20 years old</th>
            <th>21-25 years old</th>
            <th>TOTAL</th>
            <th>Kindergarten to Grade 6</th>
            <th>Transition Program</th>
            <th>TOTAL</th>
            <th>5-10 years</th>
            <th>11-15 years</th>
            <th>16-20 years</th>
    ...
    <tbody>
        <tr>
            <td style="border-top: 2px solid #000; border-bottom: 2px solid #000;"><b>With Diagnosis from Licensed Medical Specialist:</b></td>
            <td colspan="26" class="black-cell"></td>
           
        </tr>

        <tr>
            <td style="text-align: left;">1.Visual Impairment</td>
        ...
        <tr>
            <td style="text-align: left;">2. Hearing Impairment</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">3. Learning Disability</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">4. Intellectual Disability</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">5. Autism Spectrum Disorder</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">6. Emotional-Behavioral Disorder</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">7. Orthopedic/Physical Handicap</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">8. Speech/Language Disorder</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">9.Cerebral Palsy</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">10. Special Health Problem/Chronic Disease</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left; padding-left: 20px;">10.a. Cancer</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">11. Multiple Disorder</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="border-top: 2px solid #000; border-bottom: 2px solid #000;"><b>With Manifestations:</b></td>
            <td colspan="26" class="black-cell"></td>
           
        </tr>

        <tr>
            <td style="text-align: left;">1. Difficulty in Seeing</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">2. Difficulty in Hearing</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">3. Difficulty in Applying Knowledge</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">4. Difficulty in Remembering, Concentrating, Paying Attention and Understanding</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">5. Difficulty in Apply Adaptive Skills</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">6. Difficulty in Displaying Inter-Personal Behavior</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">7. Difficulty in Mobility (Walking, Climbing, and Grasping)</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
        ...
        <tr>
            <td style="text-align: left;">8. Difficulty in Communicating</td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
            <td contenteditable="true"></td>
